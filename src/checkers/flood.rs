...
fn assert_topology_on_client(net: Network, mut expected: Vec<(NodeId, NodeType)>, timeout: Duration){
...
fn test_loop_flood() {
    ...
    assert_topology_on_client(net, vec![(1, NodeType::Drone), (2, NodeType::Drone), (3, NodeType::Drone)], TIMEOUT * 3);
}